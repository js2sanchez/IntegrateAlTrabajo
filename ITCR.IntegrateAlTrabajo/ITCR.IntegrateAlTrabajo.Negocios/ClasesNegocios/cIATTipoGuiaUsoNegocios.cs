...
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'IATTipoGuiaUso'
...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'IATTipoGuiaUso'.
	/// </summary>
	public class cIATTipoGuiaUsoNegocios : cIATTipoGuiaUsoDatos
	{
		...
		/// </summary>
		public cIATTipoGuiaUsoNegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		/// <UL>
		///		 <LI>Nom_TipoGuiaUso</LI>
		/// </UL>
		/// Propiedades actualizadas luego de una llamada exitosa a este método: 
		/// <UL>
		///		 <LI>Id_TipoGuiaUso</LI>
		///		 <LI>CodError</LI>
		/// </UL>
		/// </remarks>
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cIATTipoGuiaUso;"
					+"Nom_TipoGuiaUso:"+Nom_TipoGuiaUso.ToString()+";";
			...
			catch (Exception ex)
			{
				...
				operacion = "Error Insertar cIATTipoGuiaUso;"+ex.Message;
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Actualizar cIATTipoGuiaUso;"
					+"Id_TipoGuiaUso:"+Id_TipoGuiaUso.ToString()+";"
					+"Nom_TipoGuiaUso:"+Nom_TipoGuiaUso.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Actualizar cIATTipoGuiaUso;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
		...
		public override bool Eliminar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Eliminar cIATTipoGuiaUso;"
					+"Id_TipoGuiaUso:"+Id_TipoGuiaUso.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Eliminar cIATTipoGuiaUso;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
