...
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'IATTipoContacto'
...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'IATTipoContacto'.
	/// </summary>
	public class cIATTipoContactoNegocios : cIATTipoContactoDatos
	{
		...
		/// </summary>
		public cIATTipoContactoNegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		/// <UL>
		///		 <LI>Nom_TipoContacto</LI>
		/// </UL>
		/// Propiedades actualizadas luego de una llamada exitosa a este método: 
		/// <UL>
		///		 <LI>Id_TipoContacto</LI>
		///		 <LI>CodError</LI>
		/// </UL>
		/// </remarks>
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cIATTipoContacto;"
					+"Nom_TipoContacto:"+Nom_TipoContacto.ToString()+";";
			...
			catch (Exception ex)
			{
				...
				operacion = "Error Insertar cIATTipoContacto;"+ex.Message;
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Actualizar cIATTipoContacto;"
					+"Id_TipoContacto:"+Id_TipoContacto.ToString()+";"
					+"Nom_TipoContacto:"+Nom_TipoContacto.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Actualizar cIATTipoContacto;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
		...
		public override bool Eliminar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Eliminar cIATTipoContacto;"
					+"Id_TipoContacto:"+Id_TipoContacto.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Eliminar cIATTipoContacto;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
