...
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'IATGuiaUso'
...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'IATGuiaUso'.
	/// </summary>
	public class cIATGuiaUsoNegocios : cIATGuiaUsoDatos
	{
		...
		/// </summary>
		public cIATGuiaUsoNegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cIATGuiaUso;"
					+"RutaGuia:"+RutaGuia.ToString()+";"
					+"FK_IdTipoGuiaUso:"+FK_IdTipoGuiaUso.ToString()+";";
			...
			catch (Exception ex)
			{
				...
				operacion = "Error Insertar cIATGuiaUso;"+ex.Message;
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Actualizar cIATGuiaUso;"
					+"Id_GuiaUso:"+Id_GuiaUso.ToString()+";"
					+"RutaGuia:"+RutaGuia.ToString()+";"
					+"FK_IdTipoGuiaUso:"+FK_IdTipoGuiaUso.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Actualizar cIATGuiaUso;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
		...
		public override bool Eliminar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Eliminar cIATGuiaUso;"
					+"Id_GuiaUso:"+Id_GuiaUso.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Eliminar cIATGuiaUso;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
