...
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'IATTipoTrabajo'
...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'IATTipoTrabajo'.
	/// </summary>
	public class cIATTipoTrabajoNegocios : cIATTipoTrabajoDatos
	{
		...
		/// </summary>
		public cIATTipoTrabajoNegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		/// <UL>
		///		 <LI>Nom_TipoTrabajo</LI>
		/// </UL>
		/// Propiedades actualizadas luego de una llamada exitosa a este método: 
		/// <UL>
		///		 <LI>Id_TipoTrabajo</LI>
		///		 <LI>CodError</LI>
		/// </UL>
		/// </remarks>
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cIATTipoTrabajo;"
					+"Nom_TipoTrabajo:"+Nom_TipoTrabajo.ToString()+";";
			...
			catch (Exception ex)
			{
				...
				operacion = "Error Insertar cIATTipoTrabajo;"+ex.Message;
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Actualizar cIATTipoTrabajo;"
					+"Id_TipoTrabajo:"+Id_TipoTrabajo.ToString()+";"
					+"Nom_TipoTrabajo:"+Nom_TipoTrabajo.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Actualizar cIATTipoTrabajo;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
		...
		public override bool Eliminar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Eliminar cIATTipoTrabajo;"
					+"Id_TipoTrabajo:"+Id_TipoTrabajo.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Eliminar cIATTipoTrabajo;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
