...
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'IATNoticia'
...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'IATNoticia'.
	/// </summary>
	public class cIATNoticiaNegocios : cIATNoticiaDatos
	{
		...
		/// </summary>
		public cIATNoticiaNegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cIATNoticia;"
			...
			catch (Exception ex)
			{
				...
				operacion = "Error Insertar cIATNoticia;"+ex.Message;
		...
		public override bool Eliminar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Eliminar cIATNoticia;"
					+"Id_Noticia:"+Id_Noticia.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Eliminar cIATNoticia;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
