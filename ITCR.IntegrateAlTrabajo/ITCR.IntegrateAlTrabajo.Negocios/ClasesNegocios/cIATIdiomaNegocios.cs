...
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'IATIdioma'
...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'IATIdioma'.
	/// </summary>
	public class cIATIdiomaNegocios : cIATIdiomaDatos
	{
		...
		/// </summary>
		public cIATIdiomaNegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cIATIdioma;"
					+"Nom_Idioma:"+Nom_Idioma.ToString()+";";
			...
			catch (Exception ex)
			{
				...
				operacion = "Error Insertar cIATIdioma;"+ex.Message;
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Actualizar cIATIdioma;"
					+"Id_Idioma:"+Id_Idioma.ToString()+";"
					+"Nom_Idioma:"+Nom_Idioma.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Actualizar cIATIdioma;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
		...
		public override bool Eliminar()
		{
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Eliminar cIATIdioma;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
