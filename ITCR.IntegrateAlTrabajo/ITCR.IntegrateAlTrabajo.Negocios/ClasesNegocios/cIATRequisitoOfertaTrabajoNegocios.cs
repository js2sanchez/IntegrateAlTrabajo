...
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'IATRequisitoOfertaTrabajo'
...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'IATRequisitoOfertaTrabajo'.
	/// </summary>
	public class cIATRequisitoOfertaTrabajoNegocios : cIATRequisitoOfertaTrabajoDatos
	{
		...
		/// </summary>
		public cIATRequisitoOfertaTrabajoNegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cIATRequisitoOfertaTrabajo;"
					+"Detalle:"+Detalle.ToString()+";"
					+"FK_IdOfertaTrabajo:"+FK_IdOfertaTrabajo.ToString()+";";
			...
			catch (Exception ex)
			{
				...
				operacion = "Error Insertar cIATRequisitoOfertaTrabajo;"+ex.Message;
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Actualizar cIATRequisitoOfertaTrabajo;"
					+"Id_RequisitoOfertaTrabajo:"+Id_RequisitoOfertaTrabajo.ToString()+";"
					+"Detalle:"+Detalle.ToString()+";"
					+"FK_IdOfertaTrabajo:"+FK_IdOfertaTrabajo.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Actualizar cIATRequisitoOfertaTrabajo;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
		...
		public override bool Eliminar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Eliminar cIATRequisitoOfertaTrabajo;"
					+"Id_RequisitoOfertaTrabajo:"+Id_RequisitoOfertaTrabajo.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Eliminar cIATRequisitoOfertaTrabajo;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
