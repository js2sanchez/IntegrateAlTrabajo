...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'IATServicio'.
	/// </summary>
	public class cIATServicioNegocios : cIATServicioDatos
	{
		...
		/// </summary>
		public cIATServicioNegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Actualizar cIATServicio;"
