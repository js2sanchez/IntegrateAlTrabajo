...
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'IATPersona'
...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'IATPersona'.
	/// </summary>
	public class cIATPersonaNegocios : cIATPersonaDatos
	{
		...
		/// </summary>
		public cIATPersonaNegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Actualizar cIATPersona;"
					+"Id_Persona:"+Id_Persona.ToString()+";"
					+"Nom_Persona:"+Nom_Persona.ToString()+";"
					+"Apellido1:"+Apellido1.ToString()+";"
					+"Apellido2:"+Apellido2.ToString()+";"
					+"Num_Cedula:"+Num_Cedula.ToString()+";"
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Actualizar cIATPersona;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
		...
		public override bool Eliminar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Eliminar cIATPersona;"
					+"Id_Persona:"+Id_Persona.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Eliminar cIATPersona;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
