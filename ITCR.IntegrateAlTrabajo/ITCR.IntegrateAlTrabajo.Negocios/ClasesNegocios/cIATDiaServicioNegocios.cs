...
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'IATDiaServicio'
...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'IATDiaServicio'.
	/// </summary>
	public class cIATDiaServicioNegocios : cIATDiaServicioDatos
	{
		...
		/// </summary>
		public cIATDiaServicioNegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cIATDiaServicio;"
					+"Nom_Dia:"+Nom_Dia.ToString()+";"
					+"Can_Horas:"+Can_Horas.ToString()+";"
					+"FK_IdServicio:"+FK_IdServicio.ToString()+";";
			...
			catch (Exception ex)
			{
				...
				operacion = "Error Insertar cIATDiaServicio;"+ex.Message;
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Actualizar cIATDiaServicio;"
					+"Id_DiaServicio:"+Id_DiaServicio.ToString()+";"
					+"Nom_Dia:"+Nom_Dia.ToString()+";"
					+"Can_Horas:"+Can_Horas.ToString()+";"
					+"FK_IdServicio:"+FK_IdServicio.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Actualizar cIATDiaServicio;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
		...
		public override bool Eliminar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Eliminar cIATDiaServicio;"
					+"Id_DiaServicio:"+Id_DiaServicio.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Eliminar cIATDiaServicio;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
