...
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'IATAplicantesOferta'
...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'IATAplicantesOferta'.
	/// </summary>
	public class cIATAplicantesOfertaNegocios : cIATAplicantesOfertaDatos
	{
		...
		/// </summary>
		public cIATAplicantesOfertaNegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cIATAplicantesOferta;"
			...
			catch (Exception ex)
			{
				...
				operacion = "Error Insertar cIATAplicantesOferta;"+ex.Message;
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Actualizar cIATAplicantesOferta;"
					+"Id_AplicantesOferta:"+Id_AplicantesOferta.ToString()+";"
					+"FK_IdPersona:"+FK_IdPersona.ToString()+";"
					+"FK_IdOfertaTrabajo:"+FK_IdOfertaTrabajo.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Actualizar cIATAplicantesOferta;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
		...
		public override bool Eliminar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Eliminar cIATAplicantesOferta;"
					+"Id_AplicantesOferta:"+Id_AplicantesOferta.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Eliminar cIATAplicantesOferta;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
