...
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'IATIdiomaXPersona'
...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'IATIdiomaXPersona'.
	/// </summary>
	public class cIATIdiomaXPersonaNegocios : cIATIdiomaXPersonaDatos
	{
		...
		/// </summary>
		public cIATIdiomaXPersonaNegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cIATIdiomaXPersona;"
					+"FK_IdIdioma:"+FK_IdIdioma.ToString()+";"
			...
			catch (Exception ex)
			{
				...
				operacion = "Error Insertar cIATIdiomaXPersona;"+ex.Message;
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Actualizar cIATIdiomaXPersona;"
					+"Id_IdiomaXPersona:"+Id_IdiomaXPersona.ToString()+";"
					+"FK_IdIdioma:"+FK_IdIdioma.ToString()+";"
					+"FK_IdPersona:"+FK_IdPersona.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Actualizar cIATIdiomaXPersona;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
		...
		public override bool Eliminar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Eliminar cIATIdiomaXPersona;"
					+"Id_IdiomaXPersona:"+Id_IdiomaXPersona.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Eliminar cIATIdiomaXPersona;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
