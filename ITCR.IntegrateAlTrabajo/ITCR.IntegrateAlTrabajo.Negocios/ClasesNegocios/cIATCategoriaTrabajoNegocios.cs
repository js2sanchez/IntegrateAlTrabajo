...
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'IATCategoriaTrabajo'
...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'IATCategoriaTrabajo'.
	/// </summary>
	public class cIATCategoriaTrabajoNegocios : cIATCategoriaTrabajoDatos
	{
		...
		/// </summary>
		public cIATCategoriaTrabajoNegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cIATCategoriaTrabajo;"
					+"Nom_CategoriaTrabajo:"+Nom_CategoriaTrabajo.ToString()+";";
			...
			catch (Exception ex)
			{
				...
				operacion = "Error Insertar cIATCategoriaTrabajo;"+ex.Message;
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Actualizar cIATCategoriaTrabajo;"
					+"Id_CategoriaTrabajo:"+Id_CategoriaTrabajo.ToString()+";"
					+"Nom_CategoriaTrabajo:"+Nom_CategoriaTrabajo.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Actualizar cIATCategoriaTrabajo;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
		...
		public override bool Eliminar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Eliminar cIATCategoriaTrabajo;"
					+"Id_CategoriaTrabajo:"+Id_CategoriaTrabajo.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Eliminar cIATCategoriaTrabajo;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
