...
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'IATCanton'
...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'IATCanton'.
	/// </summary>
	public class cIATCantonNegocios : cIATCantonDatos
	{
		...
		/// </summary>
		public cIATCantonNegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cIATCanton;"
					+"Nom_Canton:"+Nom_Canton.ToString()+";"
			...
			catch (Exception ex)
			{
				...
				operacion = "Error Insertar cIATCanton;"+ex.Message;
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Actualizar cIATCanton;"
					+"Id_Canton:"+Id_Canton.ToString()+";"
					+"Nom_Canton:"+Nom_Canton.ToString()+";"
					+"FK_IdProvincia:"+FK_IdProvincia.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Actualizar cIATCanton;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
		...
		public override bool Eliminar()
		{
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Eliminar cIATCanton;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
