...
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'IATDistrito'
...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'IATDistrito'.
	/// </summary>
	public class cIATDistritoNegocios : cIATDistritoDatos
	{
		...
		/// </summary>
		public cIATDistritoNegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cIATDistrito;"
					+"Nom_Distrito:"+Nom_Distrito.ToString()+";"
					+"FK_IdCanton:"+FK_IdCanton.ToString()+";";
			...
			catch (Exception ex)
			{
				...
				operacion = "Error Insertar cIATDistrito;"+ex.Message;
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Actualizar cIATDistrito;"
					+"Id_Distrito:"+Id_Distrito.ToString()+";"
					+"Nom_Distrito:"+Nom_Distrito.ToString()+";"
					+"FK_IdCanton:"+FK_IdCanton.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Actualizar cIATDistrito;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
		...
		public override bool Eliminar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Eliminar cIATDistrito;"
					+"Id_Distrito:"+Id_Distrito.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Eliminar cIATDistrito;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
