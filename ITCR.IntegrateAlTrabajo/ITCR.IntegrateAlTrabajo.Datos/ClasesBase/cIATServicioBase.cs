...
namespace ITCR.IntegrateAlTrabajo.Base
{
    ...
    public class cIATServicioBase : cBDInteraccionBase
    {
        ...
        private SqlInt32 _fK_IdTipoServicio, _fK_IdTipoServicioOld, _fK_IdPersona, _fK_IdPersonaOld, _fK_IdProvincia, _fK_IdCategoriaServicio, _fK_IdCategoriaServicioOld, _id_Servicio, _id_Provincia, _id_TipoServicio, _id_CategoriaServicio;
        ...
        public override DataTable SeleccionarUno()
        {
            ...
            try
            {
                ...
                if (toReturn.Rows.Count > 0)
                {
                    ...
                    _fK_IdProvincia = (Int32)toReturn.Rows[0]["FK_IdProvincia"];
                }
                return toReturn;
            }
            catch (Exception ex)
        ...
        public SqlInt32 FK_IdProvincia
        {
            ...
            set
            {
                SqlInt32 fK_IdProvinciaTmp = (SqlInt32)value;
                if (fK_IdProvinciaTmp.IsNull)
                {
                    throw new ArgumentOutOfRangeException("FK_IdProvincia", "FK_IdProvincia can't be NULL");
                }
