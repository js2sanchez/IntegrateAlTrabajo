...
namespace ITCR.IntegrateAlTrabajo.Base
{
	...
	public class cIATDiaServicioBase : cBDInteraccionBase
	{
        ...
        {
            SqlCommand cmdAEjecutar = new SqlCommand();
            cmdAEjecutar.CommandText = "dbo.[pr_IATDiaServicio_EliminarTodo]";
            cmdAEjecutar.CommandType = CommandType.StoredProcedure;
            ...
            try
            {
                ...
                {
                    // Genera un error.
                    throw new Exception("Procedimiento Almacenado 'pr_IATDiaServicio_EliminarTodo' reportó el error Codigo: " + _codError);
                }
            ...
            {
                // Ocurrió un error. le hace Bubble a quien llama y encapsula el objeto Exception
                throw new Exception("cIATDiaServicioBase::EliminarTodo::Ocurrió un error." + ex.Message, ex);
            }
            finally
            {
                if (_conexionBDEsCreadaLocal)
