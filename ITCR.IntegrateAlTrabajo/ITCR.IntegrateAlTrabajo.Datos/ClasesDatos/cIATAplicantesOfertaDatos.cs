...
{
	/// <summary>
	/// Propósito: Clase de acceso a datos derivada para tabla 'IATAplicantesOferta'.
	/// </summary>
	public class cIATAplicantesOfertaDatos : cIATAplicantesOfertaBase
	{
		...
		/// </summary>
		public cIATAplicantesOfertaDatos() : base()
		{
			// Agregar código aquí.
		}
