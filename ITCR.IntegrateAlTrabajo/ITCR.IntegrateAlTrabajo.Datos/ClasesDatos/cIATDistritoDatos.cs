...
// Descripción: Clase de acceso a datos para tabla 'IATDistrito'
...
{
	/// <summary>
	/// Propósito: Clase de acceso a datos derivada para tabla 'IATDistrito'.
	/// </summary>
	public class cIATDistritoDatos : cIATDistritoBase
	{
