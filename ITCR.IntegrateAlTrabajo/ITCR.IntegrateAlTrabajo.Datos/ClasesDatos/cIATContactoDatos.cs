...
// Descripción: Clase de acceso a datos para tabla 'IATContacto'
...
{
	/// <summary>
	/// Propósito: Clase de acceso a datos derivada para tabla 'IATContacto'.
	/// </summary>
	public class cIATContactoDatos : cIATContactoBase
	{
