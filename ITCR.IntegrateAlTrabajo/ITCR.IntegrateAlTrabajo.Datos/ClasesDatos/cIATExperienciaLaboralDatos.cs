...
{
	/// <summary>
	/// Propósito: Clase de acceso a datos derivada para tabla 'IATExperienciaLaboral'.
	/// </summary>
	public class cIATExperienciaLaboralDatos : cIATExperienciaLaboralBase
	{
		...
		/// </summary>
		public cIATExperienciaLaboralDatos() : base()
		{
			// Agregar código aquí.
		}
