...
{
	/// <summary>
	/// Propósito: Clase de acceso a datos derivada para tabla 'IATIdiomaXPersona'.
	/// </summary>
	public class cIATIdiomaXPersonaDatos : cIATIdiomaXPersonaBase
	{
		...
		/// </summary>
		public cIATIdiomaXPersonaDatos() : base()
		{
			// Agregar código aquí.
		}
