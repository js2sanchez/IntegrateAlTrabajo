...
{
	/// <summary>
	/// Propósito: Clase de acceso a datos derivada para tabla 'IATCalificacionEmpresa'.
	/// </summary>
	public class cIATCalificacionEmpresaDatos : cIATCalificacionEmpresaBase
	{
		...
		/// </summary>
		public cIATCalificacionEmpresaDatos() : base()
		{
			// Agregar código aquí.
		}
