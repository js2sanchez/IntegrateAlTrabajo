...
// Descripción: Clase de acceso a datos para tabla 'IATIdioma'
...
{
	/// <summary>
	/// Propósito: Clase de acceso a datos derivada para tabla 'IATIdioma'.
	/// </summary>
	public class cIATIdiomaDatos : cIATIdiomaBase
	{
