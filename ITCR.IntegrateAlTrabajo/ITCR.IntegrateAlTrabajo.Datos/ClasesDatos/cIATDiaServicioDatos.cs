...
{
	/// <summary>
	/// Propósito: Clase de acceso a datos derivada para tabla 'IATDiaServicio'.
	/// </summary>
	public class cIATDiaServicioDatos : cIATDiaServicioBase
	{
		...
		/// </summary>
		public cIATDiaServicioDatos() : base()
		{
			// Agregar código aquí.
		}
