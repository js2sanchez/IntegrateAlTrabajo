...
// Descripción: Clase de acceso a datos para tabla 'IATCanton'
...
{
	/// <summary>
	/// Propósito: Clase de acceso a datos derivada para tabla 'IATCanton'.
	/// </summary>
	public class cIATCantonDatos : cIATCantonBase
	{
