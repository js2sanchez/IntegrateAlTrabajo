...
{
	/// <summary>
	/// Propósito: Clase de acceso a datos derivada para tabla 'IATOfertaTrabajo'.
	/// </summary>
	public class cIATOfertaTrabajoDatos : cIATOfertaTrabajoBase
	{
		...
		/// </summary>
		public cIATOfertaTrabajoDatos() : base()
		{
			// Agregar código aquí.
		}
