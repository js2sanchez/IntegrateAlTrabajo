<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestraAdultoMayor.Master"
    AutoEventWireup="true" CodeBehind="frmOpinarSobreBolsaTrabajo.aspx.cs" Inherits="ITCR.IntegrateAlTrabajo.Interfaz.AdultoMayor.frmOpinarSobreBolsaTrabajo" %>
            ...
            bootbox.dialog({
                ...
                buttons: {
                    success: {
                        ...
                        callback: function () {
                            location.href = "frmConsultarPerfilAdultoMayor.aspx";
                        }
                    }
                }
            });
