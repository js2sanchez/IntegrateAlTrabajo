<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestraAdultoMayor.Master"
    AutoEventWireup="true" CodeBehind="frmActualizarServicio.aspx.cs" Inherits="ITCR.IntegrateAlTrabajo.Interfaz.AdultoMayor.frmActualizarServicio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="style3">
        <tr>
            ...
            <td class="style6">
                <asp:Label ID="lblActualizarServicio" runat="server" Text="Actualizar servicio" 
