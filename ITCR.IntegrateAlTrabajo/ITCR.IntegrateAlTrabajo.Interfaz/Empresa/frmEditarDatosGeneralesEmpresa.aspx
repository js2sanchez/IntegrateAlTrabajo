<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestraEmpresa.Master" AutoEventWireup="true" CodeBehind="frmEditarDatosGeneralesEmpresa.aspx.cs" Inherits="ITCR.IntegrateAlTrabajo.Interfaz.Empresa.frmEditarDatosGeneralesEmpresa" %>
    ...
    <table class="style3">
        <tr>
            ...
            <td class="style5" colspan="2">
                <asp:Label ID="lblActualizarDatosGenerales" runat="server" CssClass="Titulo1" 
                    Text="Actualizar datos generales"></asp:Label>
            </td>
            <td class="style7">
                &nbsp;</td>
            <td class="style5">
                ...
                <asp:Panel ID="PanelActualizarDatosGenerales" runat="server" BorderWidth="2px">
                    <table class="style10">
                            ...
                            <td class="style16" colspan="2">
                                <asp:Panel ID="PanelBotonAplicar" runat="server" HorizontalAlign="Right">
                                    <asp:Button ID="btnCancelarActualización" runat="server" CssClass="Boton" 
                                        onclick="btnCancelarActualización_Click" Text="Cancelar" TabIndex="9" />
                                    &nbsp;
                                    <asp:Button ID="btnAplicarCambios" runat="server" CssClass="Boton" 
                                        onclick="btnAplicarCambios_Click" Text="Aplicar cambios" TabIndex="8" />
                                </asp:Panel>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="style14">
                                <asp:TextBox ID="txtTelefono" runat="server" Width="300px" 
                        ...
                        <tr>
                            ...
                            <td class="style14">
                                <asp:DropDownList ID="drpProvincia" runat="server" AutoPostBack="True" 
                                    onselectedindexchanged="drpProvincia_SelectedIndexChanged" Width="181px" 
                                    TabIndex="5">
                                </asp:DropDownList>
                            </td>
                            <td class="style15">
                        ...
                        <tr>
                            ...
                            <td class="style14">
                                <asp:DropDownList ID="drpCanton" runat="server" AutoPostBack="True" 
                                    onselectedindexchanged="drpCanton_SelectedIndexChanged" Width="179px" 
                                    TabIndex="6">
                                </asp:DropDownList>
                            </td>
                            <td class="style15">
