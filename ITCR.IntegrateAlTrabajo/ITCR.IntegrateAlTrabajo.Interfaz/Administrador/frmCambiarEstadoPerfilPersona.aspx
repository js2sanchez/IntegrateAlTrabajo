<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestraAdministrador.Master"
    AutoEventWireup="true" CodeBehind="frmCambiarEstadoPerfilPersona.aspx.cs" Inherits="ITCR.IntegrateAlTrabajo.Interfaz.Administrador.frmCambiarEstadoPerfilPersona" %>
    ...
    <table class="style3">
        ...
        <tr>
            ...
            <td class="auto-style6" colspan="2">
                <asp:Label ID="lblAdultosMayores" runat="server" Text="Adultos Mayores" CssClass="Titulo2"></asp:Label>
            </td>
